...
var question = [
  {
    ...
    options: ["HTML", "HTML", "Hyper text Markup Language", "HTML"],
...
window.renderQuestionqqq = function () {
  if (totalQueation.innerHTML === QuerentQueetion.innerHTML) {
    ...
    button.setAttribute("class", "btn  btn-outline-dark px-3 py-3");
...
window.result = function () {
  ...
  h3.setAttribute("class", "bg-black rounded-pill text-white py-3");
};
